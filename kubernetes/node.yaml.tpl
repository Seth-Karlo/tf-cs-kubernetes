...
coreos:
  etcd2:
    ...
    initial-cluster: master=http://${terraform_master_ip}:2380
    proxy: on
  fleet:
    metadata: "role=node"
  units:
    ...
    - name: kube-proxy.service
      ...
      content: |
        ...
        ExecStartPre=/opt/bin/wupiao ${terraform_master_ip} 8080
        ExecStart=/opt/bin/kube-proxy \
        --master=${terraform_master_ip}:8080 \
        --logtostderr=true
        Restart=always
        RestartSec=10
    - name: kube-kubelet.service
      ...
      content: |
        ...
        --api-servers=${terraform_master_ip}:8080 \
